...
exports.index = function (req, res, next) {
  ...
  Order.getOrdersByQuery(query, options, proxy.done('orders', function (orders) {
    return orders;
  }));

  // Topic.getTopicsByQuery(query, options, proxy.done('orders', function (topics) {
  //   return topics;
  // }));
  ...
  proxy.all('topics', 'tops', 'no_reply_topics', 'pages', 'orders',
    function (topics, tops, no_reply_topics, pages, orders) {
      res.render('index', {
        topics: topics,
        orders: orders,
        current_page: page,
